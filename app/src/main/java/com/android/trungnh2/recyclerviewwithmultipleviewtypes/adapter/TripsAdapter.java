package com.android.trungnh2.recyclerviewwithmultipleviewtypes.adapter;
...
import com.android.trungnh2.recyclerviewwithmultipleviewtypes.R;
...
public class TripsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == 0) {
            ...
            ((TripViewHolder) holder).setTrip(trip);
